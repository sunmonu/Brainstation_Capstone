...
# B. Load data
pop_age_sex_path = "streamlit_targetedterritories/data/PopulationbyAgeandSexCounties.csv"
pop_race_path = "streamlit_targetedterritories/data/PopulationbyRaceCounties.csv"
target_data_path = "streamlit_targetedterritories/data/target.csv"
debt_data_path = "streamlit_targetedterritories/data/household-debt-by-county.csv"
pred_df_path = "streamlit_targetedterritories/data/streamlit_data_TargetedTerritories.csv"
